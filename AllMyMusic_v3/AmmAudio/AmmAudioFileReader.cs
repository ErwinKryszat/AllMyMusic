...
namespace NAudio.Wave
{
    ...
    /// </summary>
    public class AmmAudioFileReader : WaveStream, ISampleProvider
    {
        ...
        public AmmAudioFileReader(string fileName)
        {
        ...
        private void CreateReaderStream(string fileName)
        {
            ...
            {
                //readerStream = new AmmMp3FileReader(fileName);
                readerStream = new AmmMp3FileReader(memStream);
            }
            else if (fileName.EndsWith(".aiff"))
            {
                //readerStream = new AiffFileReader(fileName);
                readerStream = new AiffFileReader(memStream);
            }
            else
            {
                // fall back to media foundation reader, see if that can play it
                //readerStream = new MediaFoundationReader(fileName);
                //readerStream = new MediaFoundationReader(memStream);
            }
        }
