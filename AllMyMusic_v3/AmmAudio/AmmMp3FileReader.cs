...
namespace NAudio.Wave
{
    ...
    /// </summary>
    public class AmmMp3FileReader : WaveStream
    {
        ...
        public AmmMp3FileReader(string mp3FileName) 
        ...
        public AmmMp3FileReader(string mp3FileName, FrameDecompressorBuilder frameDecompressorBuilder)
        ...
        public AmmMp3FileReader(Stream inputStream)
        ...
        /// <param name="inputStream">The incoming stream containing MP3 data</param>
        /// <param name="frameDecompressorBuilder">Factory method to build a frame decompressor</param>
        public AmmMp3FileReader(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder)
        {
